...
const App = () => {
  ...
  if (loading) return <div style={{...s.loader, background: c.bg, color: c.pri}}>Cargando Interfaz desde la Nube...</div>;
          ...
          <>
            <header style={s.header}>
              <div>
                ...
                <p style={{opacity: 0.5, fontSize: '14px'}}>Sincronización de paquetes en tiempo real (Nube)</p>
              </div>
